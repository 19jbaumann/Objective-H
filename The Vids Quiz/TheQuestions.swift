...
//These help see if question is true or false
 ...
 //This function helps check if question is TRUE or FALSE, and then removes it from the array so question isn't repeated. 
    ...
    //These functions help put a question on the screen
